...
### 4. 联调红线（新增 — 2026-04-21）
- ❌ **严禁后端在没有真实前端页面成功调用的情况下声称"完成"**
- ❌ **严禁前端在没有真实后端接口成功响应的情况下声称"完成"**
- ❌ **严禁任何人（包括AI）在未提供联调证据的情况下将涉及前后端的功能标记为"完成"**
- ❌ **严禁前后端不在同一功能分支上开发**
- ❌ **严禁API契约单方面变更而不通知对方确认**
...
- [ ] 方法复杂度不超过 10
- [ ] 必须包含 JavaDoc 注释
- [ ] **如涉及前后端交互，必须在声称"完成"前完成真实联调并提供联调证据（录屏/截图/联调报告）**
- [ ] **如后端代码已就绪但尚未与前端联调，必须明确告知用户"后端代码已完成，等待前端联调，当前不算功能完成"**
...
- [ ] 集成测试通过（使用真实依赖，非 Mock）
- [ ] **前后端联调通过（必须提供联调证据，详见 STANDARD-08 §4.3）**
- [ ] 文档已更新（设计文档、API 文档）
- [ ] CHANGELOG 已更新
